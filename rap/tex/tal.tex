...
Typed assembly languages are a group of languages (not unlike assembly) that in
varying degrees introduce type safety.
The primary motivation for typed assembly languages is type safety and is
strongly related to proof-carrying code\cite{attpl}.
